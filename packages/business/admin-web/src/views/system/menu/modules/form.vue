...
import type { VbenFormSchema } from '@flexboot4/web-kit/adapter/form';
...
import { getFlexbootComponentKeys } from '@flexboot4/web-kit';
import { useVbenForm, z } from '@flexboot4/web-kit/adapter/form';
...
const schema: VbenFormSchema[] = [
  ...
  },
  {
    ...
    componentProps: {
      ...
      options: getFlexbootComponentKeys().map((v) => ({ value: v })),
    },
    dependencies: {
      rules: (values) => {
