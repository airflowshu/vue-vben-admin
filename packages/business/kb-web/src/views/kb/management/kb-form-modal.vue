...
import type { UserOption } from '@flexboot4/admin-web/api/devops/aikey';

import type { KbMember, KnowledgeBase } from '../../../api/knowledgebase';
  ...
  >
    <div class="flex flex-col">
      ...
      <div class="flex items-start px-5 pb-5">
        ...
        <div class="flex-1">
          <div
            class="collab-select flex min-h-[32px] cursor-pointer flex-wrap gap-2 rounded p-1 transition-colors"
            @click="openCollabModal"
          >
